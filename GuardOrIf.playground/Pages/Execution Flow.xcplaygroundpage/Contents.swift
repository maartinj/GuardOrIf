 ...
 */
// Film: https://www.youtube.com/watch?v=y1wVyNRJook&ab_channel=StewartLynch
// Aasif Khan Blog: https://www.appypie.com/swift-guard-let-statement-how-to
...
code(for: "Example 1 - Nested If") {
    ...
    // Must be older than 20, female and have swiftui as one of her skills
